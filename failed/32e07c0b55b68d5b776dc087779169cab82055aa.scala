...
def i5(i5: i5): i2[i5] = null
def I4[I4, i5, I3, I3, i5, i5, i5 <: I1, I3[i5] <: i0](i5: i5, I3: Int): i0[I1].I4[i5.type]
val i5: i5[I1]
new i5
...
def i5[i5](I4: i2, i5: => i5[i5, I3]] = ???
}
abstract class i5[i5] { def i5[i2](i2: => i5): i5 = i5;
}
object i5 {
val I3 = i2[i2, i2, i5] {
def I3[i5, i2](I4: I3[i5] => i5) = i5
...
def I3[i5](I3: i5): i5 = {
type i5[i5, i5] = I1[Int] var i5(i5, i5[i5], i2)
