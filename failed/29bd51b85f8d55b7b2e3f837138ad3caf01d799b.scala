...
val i0(implicit i1: i0): Set[String] = null
...
trait i1 {
val i0: Long[i0[Int]] = i0
val i1 = i1.i1.i1
}
class i1
inline def i0(): AnyRef with i1[Int, Long] inline val i0: Int ~) inline inline {
case i1(i1, inline) =>
Unit inline inline val i1: Int = 955
abstract class i1[i1, i1]
def unapply[i0]
}
abstract class i1[i0] extends i0[i0, i0[i0[type]]] { def i0(i0: List[i1], i1: i1[i1]) = (i0, i1) }