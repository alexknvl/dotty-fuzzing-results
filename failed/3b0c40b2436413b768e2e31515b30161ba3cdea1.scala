...
val i1(implicit i2: i2): Set[String] = null
...
class i2
inline def i2(): AnyRef with i2[Int, Long] inline val i2: Int ~) inline inline {
case i2(i2, inline) =>
Unit inline inline val i2: Int = 955
abstract class i2[i2, i2]
def unapply[i1]
}
abstract class i2[I0] extends I0[I0, I0[I0[type]]] { def i1(i2: List[i2], i2: i2[i2]) = (i1, i2) }