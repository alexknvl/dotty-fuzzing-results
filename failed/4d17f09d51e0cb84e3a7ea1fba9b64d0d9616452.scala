...
class i0(i0: i4[i4]) extends i4[i4] {
def I2(i4: i4): i0[i4] = null
def I1[I1, i3, I1, I1, i4, i4, i3 <: i0, I1[i4] <: i0](i4: i4, I1: Int): i0[i0].I1[I2.type]
val i4: i4[i0]
new i4
...
def i4[i4](I1: i0, i4: => i4[i4, i0]] = ???
}
abstract class I2[i4] { def i4[i0](i0: => i4): i4 = i4;
}
object i4 {
val I1 = i0[i0, i0, i4] {
def I1[i4, i0](I1: i0[i4] => i4) = i4
private var i0 = new i4(I1)
}
...
def i0[i4](i0: i4): i4 = {
type I2[i3, i4] = i0[Int] var i4(i4, i4[i4], i0)
protected def i0(i4: i0): i0[List, i4] = null
val i3 = I1.i4[i0, i4]
def i3 = I2[i4]
}