...
val i4 = i4(i4 )
def I1 = i4(5) {
val i4 = i4[Dynamic[I0[Int]] def i4[i4, i4](I1: => i4, i4: i4[i4, i4]): (0 => i4) => I0[Int, Int, Int, Int] = (i4 => (i4: Any)) (i4, i4, I0 +/ i2, I1))
@inline def I1[i4](i4: i4, i2: i4): Array[i4] = i4
def I1(i4: String = ): Unit = {}
I1.i4 = 42 match {
case i4[@specialized(scala.None) def I1(implicit I1: i4[i2]): Seq[Int] = ???
import i2._
def I1 = .0
}