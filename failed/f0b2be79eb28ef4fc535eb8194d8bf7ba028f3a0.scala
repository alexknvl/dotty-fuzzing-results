...
def i4[i4](i4: Stream[i4]): i4 <: i4 { type i3 <: i4.i4 }
implicit def I2[i4](implicit i4: i4[i4#i4]) =
i4 match {
case None =>
val i4 = i4[i4]
val i4: i0[Int, Int] = i3(List(), implicitly[i4]);
()
}
new i4 {
println(i4(5)) match {
...
trait i1[@specialized i3, i4, -i4, i3]] {
...
package i0 {
object i3 extends i4[Double, i1]
object i3 extends i0[i4, i4] {
val i4: i0[Int, Nothing] = new Array[i4]
def i1[I2](i3: i4[I2] => i4[i4 => i4]: i4[i4 <: i4]) =
